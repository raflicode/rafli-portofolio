...
<template>
  <section id="certificates" ref="certSection" class="w-full bg-bg-dark px-4 sm:px-6 lg:px-20 py-20 md:py-32 border-b border-white/5">
    <div class="max-w-4xl mx-auto">
      ...
      <div class="mb-9 md:mb-16">
        ...
        <h2 class="cert-reveal text-2xl sm:text-3xl md:text-4xl font-black tracking-tight text-white font-sans">{{ t('certificates.title') }}</h2>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          ...
          <div class="flex items-center gap-2 text-[10px] font-bold tracking-widest text-text-muted group-hover:text-white transition-colors mt-6 sm:mt-8">
